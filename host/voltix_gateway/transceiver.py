...
from voltix_gateway.packet_model import PacketApiReceive
from voltix_gateway.packet_model import PacketTransceiverSend
...
class Transceiver(object):
    ...
    def find_serial_port() -> str:
        ...
        if not hits:
            raise Exception("Couldn't find serial port of Voltix Gateway.")
        elif len(hits) == 1:
